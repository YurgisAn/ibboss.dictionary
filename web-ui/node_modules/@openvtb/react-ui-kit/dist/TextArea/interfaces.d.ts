...
export declare type LimitLabelCallback = (currentValue: ITextAreaProps['initialValue'], props: ITextAreaProps) => string | ReactNode;
export interface ITextAreaProps extends Pick<TextareaAutosizeProps, 'value' | 'onChange' | 'onHeightChange' | 'useCacheForDOMMeasurements' | 'minRows' | 'maxRows' | 'onFocus' | 'onBlur'> {
    /** Идентификатор поля */
    id?: string;
    /** Имя поля */
    name?: string;
