...
export declare type Device = 'mobile320' | 'tablet768' | 'tablet1024' | 'desktop1280' | 'desktop1600';
export declare type JustifyContent = 'center' | 'flex-start' | 'flex-end' | 'space-around' | 'space-between';
export declare type AlignItems = 'baseline' | 'center' | 'flex-start' | 'flex-end' | 'stretch';
