...
export declare type RefCallback<T> = (node: T | null) => void;
export declare type RefObject<T> = React.MutableRefObject<T | null | undefined> | React.RefObject<T | null | undefined>;
/**
