...
import { ProgressPage, ProgressPageProps } from './index';
...
export default {
  ...
  parameters: {
    ...
    design: {
      type: 'figma',
      url: 'https://www.figma.com/file/nwmAE2QMjzDD1FECyC2EUL/01-%E2%9C%85-UI-Kit-2.1-Internet-bank?node-id=67843%3A0',
    },
  },
  argTypes: {
    appearance: {
...
const Template1: Story<ProgressPageProps> = ({ ...args }) => {
  return (
    <ProgressPage
      {...args}
      label={
...
const Template2: Story<ProgressPageProps> = ({ ...args }) => {
