...
export default {
  ...
  parameters: {
    design: {
      type: 'figma',
      url: 'https://www.figma.com/file/nwmAE2QMjzDD1FECyC2EUL/01-%E2%9C%85-UI-Kit-2.1-Internet-bank?node-id=65019%3A72482',
    },
...
const Template1: Story<ToggleProps> = () => {
  return (
    <>
...
const Template2: Story<ToggleProps> = () => {
  return (
    <>
...
const Template3: Story<ToggleProps> = () => {
  return (
    <>
      <Toggle />
      <Separator />
...
const Template4: Story<ToggleProps> = () => {
  return (
    <>
...
const Template5: Story<ToggleProps> = () => {
  return (
...
const Template6: Story<ToggleProps> = ({
  dimension,
  disabled,
  width,
  labelPosition,
  ...
  const [checked, setChecked] = useState(argChecked);
  return (
    <>
      <Toggle
        checked={checked}
