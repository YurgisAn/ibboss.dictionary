...
export default {
  ...
  parameters: {
    ...
    design: {
      type: 'figma',
      url:
        'https://www.figma.com/file/nwmAE2QMjzDD1FECyC2EUL/01-%E2%9C%85-UI-Kit-2.1-Internet-bank?node-id=66663%3A81585',
    },
  },
  docs: {
    source: {
...
const PositionInPortal = ({
  ...
  useInterval(checkDropDownOpenPosition, 500, positionComponentRef, dropDownDisplay, setdropDownDisplay);
...
const Template1: Story<DropDownMenuProps> = (args) => {
  const category = [
    {
      name: 'Категория 1',
      id: '1',
  ...
  useClickOutside([buttonRef.current], outsideClick);
...
const Template2: Story<DropDownMenuProps> = (args) => {
  const items = [
    {
      id: '1',
      label: 'Option one',
