...
export default {
  ...
  parameters: {
    ...
    design: {
      type: 'figma',
      url: 'https://www.figma.com/file/nwmAE2QMjzDD1FECyC2EUL/01-%E2%9C%85-UI-Kit-2.1-Internet-bank?node-id=76653%3A42',
    },
  },
  argTypes: {
    dimension: {
...
const Template1: Story<BadgeProps> = (args) => {
  return (
    <Layout>
...
const Template2: Story<BadgeProps> = (args) => {
  return (
    <Layout>
      <String>
        <Badge>5</Badge>
...
const Template3: Story<BadgeProps> = (args) => {
  return (
    <String>
      <Button>
        Пример
