import { INPUT_DIMENSIONS_VALUES } from '#ui-kit3/components/input';
import { Modal, ModalButtonPanel, ModalContent, ModalTitle } from '#ui-kit3/components/Modal';
...
const CustomOptionTemplate: ComponentStory<typeof SearchSelect> = (props) => {
  ...
  return (
    <SearchSelect {...props} value={selectValue} onChange={onChange}>
      {OPTIONS.map((option) => (
...
const OptionGroupTemplate: ComponentStory<typeof SearchSelect> = (props) => {
  ...
  return (
    <SearchSelect {...props} value={selectValue} onChange={onChange} dimension="xl">
...
const SelectTemplate: ComponentStory<typeof SearchSelect> = (props) => {
  const [selectValue, setSelectValue] = React.useState('Похо Торо Моронго');

  const onChange = (e: ChangeEvent<HTMLSelectElement>) => setSelectValue(e.target.value);

  return (
    <SearchSelect {...props} value={selectValue} onChange={onChange} dimension="xl" mode="select">
      <Option value="Анигиляторная пушка">Анигиляторная пушка</Option>
      <Option value="Похо Торо Моронго">Похо Торо Моронго</Option>
      <Option value="Саша Даль">Саша Даль</Option>
    </SearchSelect>
...
const UncontrolledTemplate: ComponentStory<typeof SearchSelect> = (props) => {
  ...
  return (
    <Form action="" onSubmit={onSubmit}>
      <SearchSelect {...props} name="myOwesomeField" defaultValue={OPTIONS_SIMPLE[0]}>
        {OPTIONS_SIMPLE.map((option, ind) => (
          <Option key={option} value={option} disabled={ind === 4}>
            {option}
          </Option>
...
const TemplateNotFixedMultiSelect: ComponentStory<typeof SearchSelect> = (props) => {
  ...
  return (
    <SearchSelect {...props} value={selectValue} multiple={true} onChange={onChange} idleHeight="full">
      {Array.from({ length: 20 }).map((_option, ind) => (
...
const TemplateMultiSelectCustomOption: ComponentStory<typeof SearchSelect> = (props) => {
  const [selectValue, setSelectValue] = React.useState<string[]>(
  ...
  return (
    <SearchSelect {...props} value={selectValue} multiple={true} onChange={onChange}>
      {Array.from({ length: 20 }).map((_option, ind) => (
...
const TemplateMultiSelectCustomChip: ComponentStory<typeof SearchSelect> = (props) => {
  const [selectValue, setSelectValue] = React.useState<string[]>(
