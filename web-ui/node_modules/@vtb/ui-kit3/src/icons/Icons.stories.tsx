...
import { ReactComponent as CopyOutline } from '@openvtb/admiral-icons/build/documents/CopyOutline.svg';
...
export default {
  ...
  parameters: {
    design: [
      {
        type: 'figma',
        url: 'https://www.figma.com/file/eb3mxWvJpdcnG4EBj8B9V7/Admiral-Icon-Kit?node-id=1%3A93',
      },
      {
        type: 'figma',
        url: 'https://www.figma.com/file/eb3mxWvJpdcnG4EBj8B9V7/Admiral-Icon-Kit?node-id=2%3A97',
      },
      {
        type: 'figma',
        url: 'https://www.figma.com/file/eb3mxWvJpdcnG4EBj8B9V7/Admiral-Icon-Kit?node-id=2%3A95',
      },
    ],
  },
} as Meta;
        ...
        {icons.map(
          ({ Component, name, path }: { Component: React.ElementType; name: string; path: string }, index: number) => (
            <IconCard key={name + index}>
              ...
              <IconName>
                {name}{' '}
                <CopyButton text={`import { ReactComponent as ${name} } from '@openvtb/admiral-icons/${path}';`} />
              </IconName>
            </IconCard>
          ),
        )}
...
const Template2: Story = () => {
  ...
  return (
    <Text style={{ fontWeight: 400 }}>
      ...
      <ul>
        <li>
          <a href="https://www.figma.com/file/eb3mxWvJpdcnG4EBj8B9V7/Admiral-Icon-Kit?node-id=1%3A93">Макеты в Figma</a>
        </li>
        <li>
          <a href="https://www.npmjs.com/package/@openvtb/admiral-icons">Пакет в npm</a>
        </li>
      </ul>
