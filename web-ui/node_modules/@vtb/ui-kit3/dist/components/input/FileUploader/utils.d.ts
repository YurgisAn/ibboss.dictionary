export declare type Status = 'Uploaded' | 'Loading' | 'Error' | 'Queue';
export declare type Dimension = 'xl' | 'm';
export declare const formatBytes: (bytes: number, decimals?: number) => number;
export declare const dataTransferConstructorSupported: () => boolean;
/**
